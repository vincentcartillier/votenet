...
class MP3DDetectionDataset(Dataset):
    ...
    def __init__(self, 
        ...
        self.root_data_path = os.path.join(BASE_DIR, 'data/votenet_training_data/')
    ...
    def __getitem__(self, idx):
        ...
        instance_labels = np.array(h5file['instance_labels'], dtype=np.int32)
        semantic_labels = np.array(h5file['semantic_labels'], dtype=np.int32)
        ...
        size_residuals[0:instance_bboxes.shape[0], :] = \
            target_bboxes[0:instance_bboxes.shape[0], 3:6] - DC.mean_size_arr[instance_bboxes[:,-1],:]
